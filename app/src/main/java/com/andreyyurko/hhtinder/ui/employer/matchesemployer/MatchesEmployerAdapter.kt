...
class MatchesEmployerAdapter(private val likesCardList: List<Card>) :
    RecyclerView.Adapter<MatchesEmployerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cardMain.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.action_matchesFragment_to_showCvFragment)
